...
'       </div>'.
'       <div class="copyright">'.
'           <span class="footer__text"> &copy Bản quyền thuộc về <a class="footer__link" href="#"> Nhóm gồm : Hoàng ,Long , Điệp </a></span>'.
'       </div>'.
'   </div>'.
'   <!-- Modal Form -->'.
'   <div class="ModalForm">'.
...
'               </div>'.
'               <a class="authen__link">Quên con mẹ mày mật khẩu rồi à ?</a>'.
'           </div>'.
'       </div>'.
