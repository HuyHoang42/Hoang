...
'                           </li>'.
'                       </ul>'.
'                       <div class="total-money">Tổng cộng: 1.200.000đ</div>'.
...
'               </div>'.
'           </div>'.
'img src="./assets/img/product/product2.jpg" alt=""><img src="./assets/img/product/product2.jpg" alt=""><img src="./assets/img/product/product2.jpg" alt=""><img src="./assets/img/product/product2.jpg" alt=""></br>'.
'           <font size="+1.5">TÌM ĐÂU 1 CÔNG THỨC TRẮNG NHƯ DA EM BÉ? “Nhất dáng nhì da” có sai bao giờ! Nếu dáng không được chuẩn thì nhất định da phải trắng nhé! Bởi sở hữu 1 làn da trắng ngần chính là bí quyết để phái đẹp chúng ta chinh phục mọi thứ tuyệt vời nhất đấy! ➡ Nhưng… nếu da #sạm_đen, #không_đều_màu, #dưỡng_khó_trắng đã ngốn cả triệu của bạn mỗi tháng thì hãy cân nhắc sử dụng ngay bộ dưỡng trắng quyền năng này đi, CAM KẾT HÀI LÒNG với hiệu quả nhận được.</br>'.
'�👉 Đó là bộ sản phẩm dưỡng trắng quyền năng ABC – Một sản phẩm có xuất xứ từ thương hiệu Nhật Bản.☄ Gồm: Bộ Đôi Làm Trắng Da Quyền Năng ABC.1 và ABC.2 ‼ 6 ĐIỂM NỔI BẬT NHẤT CỦA BỘ SẢN PHẨM:</br>'.
'� Dưỡng trắng chuyên sâu cho làn da đen lỳ bẩm sinh, đen khó trắng khó trị nhất.</br>'.
'� Làm đều màu da cho các vùng da khó tác động nhất.</br>'.
'� Giảm thiểu nếp nhăn, làm mờ nám sạm và chống lão hóa da tốt nhất</br>'.
'� Tăng khả năng đàn hồi cho da, cho da săn chắc, căng mướt nhất</br>'.
'� Se khít lỗ chân lông, dưỡng ẩm và kiềm dầu hiệu quả nhất.</br>'.
'� Chống nắng tối ưu, ngăn ngừa tác động của ánh nắng mặt trời, bảo vệ da khỏe mạnh với công thức tự nhiên nhất.</br>'.
'� Thành phần: … ❣❣ Chỉ với 2 bước bôi thoa mỗi ngày, da trắng bền vững, không lo xuống tone, căng mướt không bắt nắng, da trăng mịn như em bé.</br>'.
'/font>'.
'img src="./assets/img/product/product2.jpg" alt=""><img src="./assets/img/product/product2.jpg" alt=""><img src="./assets/img/product/product2.jpg" alt=""><img src="./assets/img/product/product2.jpg" alt="">'.
'                '.
'                   </div>'.
'               </div>'.
'           </div>'.
...
'       </div>'.
'       <div class="copyright">'.
'           <span class="footer__text"> &copy Bản quyền thuộc về <a class="footer__link" href="#"> Nhóm CNTT </a></span>'.
'       </div>'.
'   </div>'.
'   <!-- Modal Form -->'.
'   <div class="ModalForm">'.
